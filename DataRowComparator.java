...
/**
 * @author Abhaya Jayantilal Doshi
 * Date: 2017.08.05(yyyy-mm-dd)
 * Class Name: DataRowComparator
 *
 */

package edu.projects.dataset;
...
public class DataRowComparator implements Comparator<DataRow>, Serializable
{
	...
	/**
	 * CompareProperties object holding values related to how to compare two DataRows
	 */
	 ...
	 * @Returns -1 if dr1 < dr2, 0 if dr1=dr2, 1 if dr1 > dr2
	 */
	@Override
